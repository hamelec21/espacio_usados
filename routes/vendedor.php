...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/vendedor/dashboard', App\Livewire\Vendedor\Dashboard::class)->name('vendedor.dashboard');
    //rutas para los productos
    Route::get('/vendedor/productos/show-productos', App\Livewire\Vendedor\Productos\ShowProductos::class)->name('show-productos');
    Route::get('/vendedor/productos/crear-producto', App\Livewire\Vendedor\Productos\CrearProductos::class)->name('crear-productos');
