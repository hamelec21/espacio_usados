              ...
              bg-[url('../images/widgets/m-p2.png')] bg-no-repeat bg-right-bottom dropdown-menu">
                ...
                <li class="dropdown">
                    ...
                    <div id="navAuth"
                        ...
                        <ul class="py-1">
                            <li>
                                <a href="{{ route('show-categorias') }}" class="nav-link  dark:hover:bg-slate-800/70">Crear Categorias</a>
                            </li>
                            <li>
                                <a href="{{ route('show-tipo-entrega') }}" class="nav-link  dark:hover:bg-slate-800/70">Crear Tipo Entrega</a>
                            </li>
                            <li>
                                <a href="{{ route('show-estado-producto') }}"
                                    class="nav-link  dark:hover:bg-slate-800/70">Crear Estado Producto</a>
                            </li>
                            <li>
                                <a href="{{ route('show-estado-publicacion') }}" class="nav-link  dark:hover:bg-slate-800/70">Crear Estado Publicación</a>
                            </li>
                            <li>
                                <a href="{{route ('show-estado-usuario') }}" class="nav-link  dark:hover:bg-slate-800/70">Crear Estado Usuario</a>
                            </li>
                            <li>
                                <a href="{{ route('show-marcas') }}" class="nav-link  dark:hover:bg-slate-800/70">Crear Marcas</a>
                            </li>
                            <li>
                                <a href="{{ route('show-modelos') }}" class="nav-link  dark:hover:bg-slate-800/70">Crear Modelos</a>
                            </li>
                        </ul>
                    </div>
