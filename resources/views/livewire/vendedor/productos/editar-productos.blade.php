<div>
    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="container mx-auto px-4 mb-10">
            <div
                class="bg-green-600 text-white font-bold text-2xl text-center py-4 rounded-lg px-4 flex items-center justify-center">
                <div class="flex items-center">
                    <img src="{{ asset('images/iconos/product-lauch.png') }}" class="w-10 h-10">
                    <div class="ml-2">¡Vamos a Editar  Tu Producto!</div>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            <div class="container mx-auto">
                <form wire:submit="editar" enctype="multipart/form-data">
                    ...
                    <div class="container mx-auto px-4 drop-shadow-lg border border-gray-100 rounded-lg mt-5">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-10">
                            ...
                            <div class="col-span-2 lg:col-span-1">
                                <select wire:model.live="marcas_id" type="text" id="marcas_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            ...
                            <div class="col-span-2 lg:col-span-1">
                                <select wire:model.live="material_id" type="text" id="material_id"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option value="">Seleccione Marca</option>
                                    @foreach ($materiales as $marca)
                                        <option value="{{ $marca->id }}">{{ $marca->nombre }}</option>
                                    @endforeach
                                </select>
                                <x-input-error for="categorias_id" />
