<div>
 ...
 <div class="container mx-auto px-4">
    <div class="mt-10 mb-10">
        <h1 class="text-center text-xl font-bold  text-gray-700 dark:text-gray-200">Listado de Subcategorias</h1>
    </div>
                ...
                <div class="container">
                    <div class="shadow-md sm:rounded-lg border-gray-200 border">
                        <div
                            ...
                            <a href="{{ route('crear-subcategoria') }}">
                                <button class="btn-agregar ">Crear Subcategoria</button>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-max w-full table-auto ">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">SubCategoria</th>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="flex items-center justify-around py-[4px]">
                                            <a
                                            href="{{ route('editar-subcategoria', ['id' => $categoria->id]) }}">
