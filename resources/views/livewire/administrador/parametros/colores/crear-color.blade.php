                    ...
                    <form wire:submit="save" class="max-w-sm mx-auto mt-10 mb-10">
                        <div class="mb-5">
                            <label for="base-input"
                                ...
                                Categoria</label>
                            <input wire:model="hex_code" type="color" id="base-input"
                        ...
                        <div class="flex justify-center mt-5">
                            ...
                            {{ $this->colors->hex_code }}
                        </div>
                        <div>
                            @if ($this->colors)
                                <div style="background-color: {{ $this->colors->hex_code}}; width: 10px; height: 10px;"></div>
                            @endif
                        </div>
                    </form>
