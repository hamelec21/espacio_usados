 ...
 <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
    <div class="container mx-auto px-4">
        <div class="mt-10 mb-10">
            <h1 class="text-center text-xl font-bold  text-gray-700 dark:text-gray-200">Materieales</h1>
        </div>
                    ...
                    <div class="container">
                        <div class="shadow-md sm:rounded-lg border-gray-200 border">
                            <div
                                ...
                                <a href="{{ route('crear-material') }}">
                                    <button class="btn-agregar ">Crear Material</button>
                                </a>
                            </div>
                        </div>
                    </div>
