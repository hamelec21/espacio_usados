            ...
            <div class="flex items-center justify-center  font-sans overflow-hidden">
                <div class="w-full lg:w-5/6">
                                ...
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        <div class="flex items-center">
                                            <span>{{ $estadoproducto->id }}</span>
                                        </div>
                                    </td>
                                    <td class="py-3 px-6 text-left">
                                        <span>{{ $estadoproducto->nombre }}</span>
                                    </td>
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            <div class="flex items-center justify-around py-[4px]">
                                                <a
                                                href="{{ route('editar-estado-producto', ['id' => $estadoproducto->id]) }}">
                    ...
                    <div class="bg-gray-200">
                        @if ($estadoproductos->hasPages())
                            <div class="px-6 py-3 ">
                                {{ $estadoproductos->links() }}
                            </div>
                        @endif
                    </div>
                </div>
