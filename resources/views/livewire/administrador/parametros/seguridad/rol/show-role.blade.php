...
<div class="container mx-auto px-4">
    <div class="mt-10 mb-10">
        <h1 class="text-center text-xl font-bold  text-gray-700 dark:text-gray-200 uppercase">Roles de Usuarios</h1>
    </div>
                ...
                <div class="container">
                    <div class="shadow-md sm:rounded-lg border-gray-200 border">
                        <div
                            ...
                            <a href="{{ route('crear-role') }}">
                                <button class="btn-agregar ">Crear Nuevo Rol</button>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-left">Nombre Rol</th>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <div class="flex items-center justify-around py-[4px]">
                                            <a
                                            href="{{ route('editar-role', ['id' => $role->id]) }}">
                                        ...
                                        <div class="mt-1 px-3">
                                            <a onclick="confirm('¿Estas Seguro de Eliminar El Rol?')||event.stopImmediatePropagation()"
                                                wire:click="destroy({{ $role->id }})"><button
