    ...
    <section class="px-4 mt-10">
        <div class="container mx-auto  mt-5 mb-5 rounded-md border-gray-300 border">
            ...
            <div class="lg:flex justify-between px-4 ">
                ...
                <div class="px-4">
                    <select wire:model.live="filtro_region" class="rounded-md mt-5 mb-5 border-gray-300 w-full text-gray-700 ">
                ...
                <div class="px-4">
                    <select wire:model.live="filtro_comuna" class=" rounded-md mt-5 mb-5 border-gray-300 w-full  text-gray-700 ">
    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 px-4">
            ...
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                    <img src="{{ asset('storage/' . $producto->foto1) }}" alt="{{ $producto->foto1 }}" class="w-full">
                    <div
