<div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80] 2xl:w-[85%] ">
        <div class="mt-20 mb-10">
            <h1 class="text-center text-xl font-bold  text-gray-700 dark:text-gray-200">Formulario de Edición de Tipo Entregas</h1>
        </div>
        <div class="container mx-auto  border-gray-200 border px-8 mt-10">
            ...
            <form wire:submit="editar" class="max-w-sm mx-auto mt-10 mb-10">
                <div class="mb-5">
                    ...
                    <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Editar Tipo Categoria</label>
