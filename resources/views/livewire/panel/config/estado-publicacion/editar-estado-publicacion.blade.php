<div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80] 2xl:w-[85%] p-5">
        ...
        <div class="container mx-auto  border-gray-200 border px-8 mt-10 bg-white shadow-lg dark:bg-gray-900">

            <form wire:submit="editar" class="max-w-sm mx-auto mt-10 mb-10">
                <div class="mb-5">
                    <input type="hidden" wire:model="estadoproductoId">
                    <label for="base-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Editar Estado Publicacion</label>
