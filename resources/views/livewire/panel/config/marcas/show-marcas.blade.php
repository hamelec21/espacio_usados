<div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80] 2xl:w-[85%] p-5">
        <div class="mt-20 mb-10">
            <h1 class="text-center text-xl font-bold  text-gray-700 dark:text-gray-200">Listado de Marcas</h1>
        </div>
                    ...
                    <div class="container">
                        <div class="shadow-md sm:rounded-lg border-gray-200 border">
                            <div
                                ...
                                <a href="{{ route('crear-marca') }}">
                                    <button class="btn-agregar ">Crear Nuevo Marca</button>
                                </a>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            <div class="flex items-center justify-around py-[4px]">
                                                <a
                                                href="{{ route('editar-marca', ['id' => $marca->id]) }}">
                                                <button class="btn-editar mb-1">Editar</button>
                                            </div>
                                            <div class="mt-1 px-3">
                                                <a onclick="confirm('¿Estas Seguro de Eliminar La Marca?')||event.stopImmediatePropagation()"
                                                    wire:click="destroy({{ $marca->id }})"><button
